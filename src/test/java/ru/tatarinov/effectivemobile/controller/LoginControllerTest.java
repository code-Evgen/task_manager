...
class LoginControllerTest {
    ...
    void loginFailTest() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc
                ...
                .andDo(print())
                .andExpect(result -> assertTrue(result.getResolvedException() instanceof AuthenticationFailException))
                .andReturn();
    }
    ...
    void registrationTest() throws Exception {
        ...
        Assert.assertEquals("new-user@mail.ru", userService.getUserById(4).get().getMail());
    }
}